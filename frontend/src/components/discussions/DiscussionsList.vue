...
export default {
  ...
  methods: {
    ...
    addToSelection (item) {
      console.log('-C- DiscussionsList > addToSelection > item : ', item)
      ...
      console.log('-C- DiscussionsList > addToSelection > this.itemsSelection : ', this.itemsSelection)
    },
    deleteSelection () {
      // TO DO
      console.log('-C- DiscussionsList > deleteSelection > this.itemsSelection : ', this.itemsSelection)
    },
    resetQuery () {
