...
export default {
  ...
  methods: {
    ...
    addToSelection (item) {
      console.log('-C- IssuesList > addToSelection > item : ', item)
      ...
      console.log('-C- IssuesList > addToSelection > this.itemsSelection : ', this.itemsSelection)
    },
    deleteSelection () {
      // TO DO
      console.log('-C- IssuesList > deleteSelection > this.itemsSelection : ', this.itemsSelection)
    },
    resetQuery () {
